...
public class GraficoMedicoes extends View{
	...
	private static final int ZOOM_YEAR = 0;
	private static final int ZOOM_MONTH = 1;
	private static final int ZOOM_WEEK = 2;
	private static final int ZOOM_DAT = 3;
	private Integer currentRefZoom = null;
...
//	                	Log.d("motion", "Pretendido: " + (actualTranslation + 2*(barWidth + barMargin)));
	...
	protected void onDraw(Canvas canvas) {
		...
		plotarGrafico(canvas, ZOOM_YEAR, -1);
		
	}
	
	private void plotarGrafico(Canvas canvas, int zoom, int referenceZoom) {
		
		switch(zoom) {
			
			case ZOOM_YEAR: /********************************************************** ZOOM_YEAR **********************************************************************************/
